		...
		<>
			<div
				className={
					...
					' absolute z-40 w-full h-48 py-8 bg-[#fe8529] text-center transition-top ease-in-out duration-1000 md:bg-transparent md:border-0 md:flex md:flex-row justify-end md:py-4 md:pr-4 md:top-0 md:h-0 md:transition-none'
				}>
